...
players.each do |player|
  Player.create(:name => player[:name], :number => player[:player_number], :team_id => 105, :position => player[:position], :nationality => player[:nationality], :dob => player[:date_of_birth])
  # puts player[:name]
